...
import categoryWomen from "@/assets/categories/category-women.jpg";
import categoryMen from "@/assets/categories/category-men.jpg";
...
const CategoryCards = () => {
  ...
  const categories = [
    { label: t("category.women"), image: categoryWomen, href: getCollectionPath("women") },
    { label: t("category.men"), image: categoryMen, href: getCollectionPath("men") },
  ];
